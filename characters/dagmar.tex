...
% Headline
\CharacterName{Unnamed Silver Orb}
...
\InvestigationBonus{5} % +5 Observant
\PerceptionBonus{5} % +5 Observant
...
\AddProficientDexWeapon{Dagger}{1d4}{p}
\AddProficientDexWeapon{Light Crossbow}{1d8}{p}
\AddProficientDexWeapon{Stiletto Dagger}{1d3}{p}
...
50 ft hempen rope,
Jeweller's tools,
Gilbmarrow's map of Northern Gulala
}
